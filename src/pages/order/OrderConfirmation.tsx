// src/pages/order/OrderConfirmation.tsx
          ...
          <motion.div variants={itemVariants} className="text-center">
            {isPaymentPending ? (
              <>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base mb-3 max-w-2xl mx-auto">
            ...
            <div className="mt-3 sm:mt-4 bg-primary/10 text-primary px-3 sm:px-4 py-2 rounded-lg inline-block">
              <p className="font-semibold text-sm sm:text-base">Order #{order.id.slice(-8).toUpperCase()}</p>
            </div>
            ...
            {isPaymentPending && (
              <div className="mt-4 max-w-2xl mx-auto space-y-3">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 sm:p-4">
                  <div className="flex items-start space-x-2">
                    <Phone size={16} className="text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                    <div className="text-left">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-2">
                    {order.order_items.slice(0, 3).map((item, index) => (
                      <div key={item.id} className="flex items-center space-x-2 text-xs sm:text-sm">
                ...
                {isPaymentPending && (
                  <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
                    <a
                      ...
                      className="w-full flex items-center justify-center space-x-2 bg-green-600 text-white py-2 sm:py-3 rounded-lg hover:bg-green-700 transition-colors text-sm"
                    >
                      <Phone size={16} />
